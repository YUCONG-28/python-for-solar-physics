...
| utility | `solar_toolkit/visualization/image_web_viewer/` | Flask app factory, folder scanner, Canvas frontend assets, and MP4/GIF/WebM recording/export helpers for local image sequence review. | `scripts/tools/run_image_web_viewer.py` and browser API routes under `/api/*`. |
