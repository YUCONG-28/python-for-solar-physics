    ...
    try:
        ...
        if data.ndim == 2 :
           ...
           dataout = [spectrogram(data=data, time=time, freq=freq, 
                                  polar=polars,dateobs = dateobs,unit=unit)]
...
if __name__ == '__main__':
    #DATA DIR
    file_path=r'D:\spike_topping_type_III\20250503\OROCH_MWRS01_SRSP_L1_05M_20250503072013_V01.01.fits'
    ...
    for i, data in enumerate(dataout):
        ...
        ax.set_title("CSO Radio Spectrum " + data.polar[0] + ' '+ data.dateobs[0:10] , fontsize = 12)
