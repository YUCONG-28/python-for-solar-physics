# 模块用途: 扩展测试 AIA、射电源和 HMI 的综合叠加绘图流程。
# 主要输入: AIA、射电和 HMI 测试数据。
# 主要输出/运行说明: 输出多仪器叠加图，用于开发阶段验证。
"""
...
class Config:
    ...
    output_dir: str = (
        r"<PROJECT_ROOT>\2025\20250124\AIA_RS_HMI\RR+LL_peak mode_0.75"
    )
    ...
    def __post_init__(self):
        apply_config_to_object(self, "test_aia_radio_hmi_overlay_extended")
