...
if __name__ == "__main__":
    ...
    input_dir_AIA = '<DATA_ROOT>/JSOCdata/AIA_131/fits/44/'
    output_dir = '<DATA_ROOT>/HXI_CLEAN/25_4_24/plot/20-50/131/'
    ...
    hxi_file_path = '<DATA_ROOT>/HXI_CLEAN/25_4_24/20-50.fits'
