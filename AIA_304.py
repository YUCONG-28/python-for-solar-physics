# -*- coding: utf-8 -*-
"""
Created on Sun Mar 16 20:02:05 2025
...
input_dir = '<DATA_ROOT>/JSOCdata/AIA_304/'
output_dir = '<DATA_ROOT>/JSOCdata/AIA_304/plot/'
os.makedirs(output_dir,exist_ok=True)
fits_files = glob.glob(os.path.join(input_dir, "*.fits"))[120:121]
...
for file_path in fits_files:
    AIA_304_IMAGE=file_path
    my_map = sunpy.map.Map(AIA_304_IMAGE)
    ...
    normalized_map.plot(axes=ax, norm= colors.LogNorm(vmin=vmin, vmax=0.1*np.max(my_submap.data)))
