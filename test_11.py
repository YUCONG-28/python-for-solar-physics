# -*- coding: utf-8 -*-
"""
Created on Sat Apr 12 23:30:15 2025
...
if __name__ == "__main__":
    ...
    input_dir_AIA = 'D:/Flare/JSOCdata/AIA_1600/'
    input_dir_HMI = 'D:/Flare/JSOCdata/HMI/'
    output_dir = 'D:/hxidata/plot/'
    ...
    # 旋转数据180度
    rotated_data = np.rot90(aia2.data, 2)
    rotated_aia2 = sunpy.map.Map(rotated_data, aia2.meta)
                    
    file_path = 'D:/hxidata/HXI_CLEAN/hxi_imgcube_04e09t_20240808_192000_HXI_CLEAN.fits'
    hdul=fits.open(file_path)
    header = hdul[14].header
    print(header)
    ...
    header['crpix1']=3+header['crpix1']#右
    header['crpix2']=-3+header['crpix2']#上
    hximap = sunpy.map.Map(hdul[14].data,header)
    
    fig = plt.figure(figsize=(8, 8))
    
    ax = fig.add_subplot(projection=rotated_aia2)
    rotated_aia2.plot(axes=ax, cmap='hmimag',norm=norm)
    rotated_aia2.draw_grid(axes=ax)
