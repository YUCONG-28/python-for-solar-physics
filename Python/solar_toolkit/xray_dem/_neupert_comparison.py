...
from .processing import calculate_derivative as _calculate_derivative
...
def visualize_results(
    ...
    *,
    ...
    figure.tight_layout()
    if save_fig:
        figure.savefig(fig_name, dpi=dpi, bbox_inches="tight")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output", default=FIG_NAME)
