...
English: Save drift-selection previews, CSV tables, metadata JSON, and cutout
figures without depending on the historical plotting monolith.

中文：保存漂移率选点预览图、CSV 表格、元数据 JSON 和局部裁剪图，避免新
代码继续依赖历史大型绘图脚本。
"""
