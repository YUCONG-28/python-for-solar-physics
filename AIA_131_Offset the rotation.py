...
data_dir = '<DATA_ROOT>/JSOCdata/AIA_131/fits'
...
output_dir = '<DATA_ROOT>/JSOCdata/AIA_131/plot_offset/'
...
for i in range(200):  # 从 0 到 4
    ...
    ani = aia_sequence_aligned[i].plot(axes=ax, cmap='sdoaia131', norm=norm)
