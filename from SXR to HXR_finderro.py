...
if __name__ == "__main__":
    ...
    ax1.set_title("GOES-16 Solar Soft X-ray Flux (0.5-4 Å)   2024-08-08", 
    ...
    ax2.set_title("GOES-16 Solar Soft X-ray Flux (1.0-8 Å)   2024-08-08", 
                  fontsize=14, fontweight="bold")
    ...
    ax3.semilogy(time_subset, xrsa_flux_subset, label='原始数据', color='lightcoral', alpha=0.5)
    ax3.semilogy(time_subset, xrsa_smoothed, label='平滑后', color='red')
    ax3.legend()
    ax3.set_ylabel("Flux (W/m²)", fontsize=12, labelpad=10)
    ax3.set_title("GOES-16 Solar Soft X-ray Flux (0.5-4 Å))", 
                  fontsize=14, fontweight="bold")
    ...
    ax4.semilogy(time_subset, xrsb_flux_subset, label='原始数据', color='lightgreen', alpha=0.5)
    ax4.semilogy(time_subset, xrsb_smoothed, label='平滑后', color='green')
    ax4.legend()
    ax4.set_ylabel("Flux (W/m²)", fontsize=12, labelpad=10)
    ax4.set_title("GOES-16 Solar Soft X-ray Flux (1.0-8 Å))", 
                  fontsize=14, fontweight="bold")
