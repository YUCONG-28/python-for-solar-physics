...
if __name__ == "__main__":
    file_path = '<DATA_ROOT>/HXI_CLEAN/25_5_8/19_22-19_23___30-50.fits'
    hdul=fits.open(file_path)
    
    output_dir = '<DATA_ROOT>/HXI_CLEAN/25_5_8/plot'
    ...
    #AIA_171_IMAGE='<DATA_ROOT>/JSOCdata/AIA_1600/aia.lev1_uv_24s.2024-08-08T192216Z.1600.image_lev1.fits'
    AIA_171_IMAGE='<DATA_ROOT>/JSOCdata/AIA_304/aia.lev1_euv_12s.2024-08-08T192243Z.304.image_lev1.fits'
