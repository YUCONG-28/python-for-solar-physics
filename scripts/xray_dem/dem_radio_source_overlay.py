...
CONFIG = {
    ...
    # └─────────────────────────────────────────────────────────┘
    "aia_fits_path": (
        r"D:\spike_topping_type_III\2025\20250124\DEM\aia_data"
        r"\aia.lev1_euv_12s.2025-01-24T044747Z.211.image_lev1.fits"
    ),
    "tb_data_path": (r"D:\spike_topping_type_III\2025\20250124\DEM\Tb_223000000.0.npy"),
    # ┌─────────────────────────────────────────────────────────┐
    # │  射电源叠加开关 & 路径                                   │
    # │                                                          │
    ...
    "overlay_radio": True,
    "radio_sources_dir": (
        r"D:\spike_topping_type_III\2025\20250124\share\Data\UnPack"
...
CONFIG = load_script_config("dem_radio_source_overlay", CONFIG)
