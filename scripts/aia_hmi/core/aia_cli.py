"""Command-line interface for the AIA EUV processor."""
...
from .aia_config import AIAConfig, _normalize_wave_float_dict
from .aia_processor import _actual_mode, process_aia_fits
