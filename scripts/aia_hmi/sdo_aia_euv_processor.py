...
mosaics from wavelength subdirectories such as:
    ...
    D:\\spike_topping_type_III\\2024\\20240110\\SDO\\AIA\\94
    D:\\spike_topping_type_III\\2024\\20240110\\SDO\\AIA\\171

CLI examples:

    python sdo_aia_euv_processor.py --root D:\\spike_topping_type_III --year 2024 --date 20240110 --mode single --waves 94 131 171 193 211 304 335 1600

    python sdo_aia_euv_processor.py --root D:\\spike_topping_type_III --year 2024 --date 20240110 --mode mosaic --waves 94 131 171 193 211 304 335 1600

    python sdo_aia_euv_processor.py --root D:\\spike_topping_type_III --year 2025 --date 20250803 --mode single --waves 171 193 --roi -700 -100 -100 400
...
Test mode examples:
    ...
    python sdo_aia_euv_processor.py --mode test --test-file D:\\spike_topping_type_III\\2024\\20240110\\SDO\\AIA\\171\\your_file.fits --roi -700 -100 -100 400

    python sdo_aia_euv_processor.py --mode test --root D:\\spike_topping_type_III --year 2024 --date 20240110 --test-wave 171 --test-index 99 --roi -700 -100 -100 400

    python sdo_aia_euv_processor.py --mode test --root D:\\spike_topping_type_III --year 2024 --date 20240110 --test-wave 193 --test-index 49 --colorbar

    python sdo_aia_euv_processor.py --mode test --root D:\\spike_topping_type_III --year 2024 --date 20240110 --test-wave 94 --test-index 99 --vmax 1200
...
class AIAConfig:
    # ===== 用户最常修改区域 =====
    root_dir: str = r"D:\spike_topping_type_III"
    year: str = "2026"
    date: str = "20260326"
