...
MODULE_SPECS = [
    ...
    {
        "id": "gaussian-source-fitting",
        "title": "Gaussian Source Fitting",
        "category": "Tools and Media",
        "status": "utility",
        "risk_level": "standard",
        "script_path": "scripts/tools/gaussian_source_fitting.py",
        "description": "Run the compatibility Gaussian source fitting helper.",
    },
    {
