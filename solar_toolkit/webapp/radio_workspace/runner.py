...
from solar_toolkit.webapp.runner import (
...
class RadioRunManager:
    ...
    def __init__(
        ...
        *,
        ...
        self.python_executable = str(python_executable or default_python_executable())
    ...
    def _validate_structured_config_paths(self, action, config: dict[str, Any]) -> None:
        ...
        elif module == "solar_toolkit.radio.pipeline_cli":
        ...
        elif module == "solar_toolkit.radio.overlay_cli":
        ...
        elif module == "solar_toolkit.radio.quicklook":
    ...
    def _validate_event_config_name(value: Any) -> None:
        ...
        from solar_toolkit.radio import configs as config_package
