...
data_dir = '<DATA_ROOT>/JSOCdata/AIA_1600/'
...
output_dir = '<DATA_ROOT>/JSOCdata/AIA_1600/plot_offset/'
...
for i in range(100):  # 从 0 到 4
    fig = plt.figure()
    ax = fig.add_subplot(projection=aia_sequence_aligned[i])
    ani = aia_sequence_aligned[i].plot(axes=ax, cmap='sdoaia1600', norm=norm)
