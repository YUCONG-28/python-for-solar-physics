# -*- coding: utf-8 -*-
"""
Created on Sat May 17 00:46:05 2025
...
data_dir = '<DATA_ROOT>/JSOCdata/All/AIA_94/'
...
output_dir = '<DATA_ROOT>/JSOCdata/All/AIA_94/plot/'
...
for i in range(597):
    ...
    ani = aia_sequence_aligned[i].plot(axes=ax, cmap='sdoaia94', norm=norm)
