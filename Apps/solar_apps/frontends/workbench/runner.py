...
def default_python_executable() -> str:
    """Return the Miniforge interpreter selected by the Apps launcher."""

    return str(selected_python_executable())
...
def prepend_conda_dll_paths_to_env(
    env: dict[str, str] | None = None,
    python_executable: str | Path | None = None,
) -> dict[str, str]:
    """Compatibility name for the platform-owned Miniforge environment builder."""
