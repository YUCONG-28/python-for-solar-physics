...
#         file_path = '<DATA_ROOT>/LASCO_C2.jp2'
...
file_path= '<DATA_ROOT>/JSOCdata/AIA_171/aia.lev1_euv_12s.2024-08-08T192222Z.171.image_lev1.fits'
lasco_map = Map('<DATA_ROOT>/LASCO_C2.jp2')
